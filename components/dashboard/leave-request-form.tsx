...
export default function LeaveRequestForm() {
  ...
  const selectedSuccessor = useMemo(
    () => successorOptions.find(emp => (emp.uid || emp.id) === selectedSuccessorUid),
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="rounded-lg border bg-card p-4 space-y-4">
              <SectionHeader number={2} icon={CalendarIcon} title="ໄລຍະເວລາລາ" />
                ...
                <div className="flex items-center gap-3 rounded-md bg-muted/60 px-3 py-2.5">
                  ...
                  <div className="min-w-0">
                    <p className="text-sm font-medium truncate">
                      {[selectedSuccessor.firstNameLo || selectedSuccessor.firstNameEn, selectedSuccessor.lastNameLo || selectedSuccessor.lastNameEn].filter(Boolean).join(' ')}
                    </p>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-xs text-muted-foreground flex items-center gap-1 mt-0.5">
                      ...
                      {request.duration !== undefined && (
                        <span className="ml-1 opacity-70">· {formatDuration(request.duration)}</span>
                      )}
                    </p>
                  </div>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">{selectedLeave.startPeriod === 'morning' ? 'ຕອນເຊົ້າ' : 'ຕອນບ່າຍ'}</p>
                </div>
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">{selectedLeave.endPeriod === 'morning' ? 'ຕອນເຊົ້າ' : 'ຕອນບ່າຍ'}</p>
                </div>
              </div>
