...
export default function TheThemes({ color }: { color?: string } = {}) {
  ...
  <PopoverTrigger asChild>
    <Button variant="outline" size="icon" className={`hover:bg-sidebar-accent hover:text-sidebar-accent-foreground active:scale-95 transition-all touch-none select-none focus:ring-2 ${color}`}>
