...
export const metadata: Metadata = {
  ...
  description:
    "ລະບົບ HRM ຂອງ SSMI Laos ຊ່ວຍພະນັກງານຈັດການການເຂົ້າວຽກ, ການລາພັກ, ການອະນຸມັດ ແລະ ຂໍ້ມູນສ່ວນຕົວ ໃນລະບົບດຽວຢ່າງປອດໄພ | SSMI Laos HRM web Portal for Staff",
  keywords: [
    "ພະນັກງານສິນຊັບເມືອງເໜືອ",
    "ssmi laos staff",
    "hrm ssmi laos",
    "ssmi laos",
    "SSMI",
